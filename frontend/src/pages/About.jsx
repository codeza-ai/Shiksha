...
const About = ()=>{
    return (<>
        ...
        <div className="w-full h-fit flex flex-col items-center justify-center p-3">
            <div className="md:w-3/4 w-full bg-gray-100 p-2 md:p-4 rounded-lg  h-fit md:text-lg text-md mt-10">
                <h2 className="md:text-2xl text-lg font-bold text-black">About us:</h2>
                <p className="mt-3">
            ...
            <div className="md:w-3/4 w-full bg-white p-2 md:p-4 rounded-lg border-2 border-gray-200 h-fit md:text-lg text-md mt-10">
                <a href="https://sdgs.un.org/goals/goal4"
                    className="md:text-2xl text-lg font-extrabold text-blue-500 hover:text-blue-700">SDG 4 - Quality Education</a>
            ...
            <div className="md:w-3/4 w-full p-2 md:p-4 gap-4 md:gap-8 md:text-lg text-md mt-10 border-2 border-gray-200 md:flex-row flex flex-col justify-evenly bg-white rounded-lg">
