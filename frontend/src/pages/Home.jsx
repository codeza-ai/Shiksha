...
const Home = () => {
    return (
        <>
            ...
            <main id="hero" className='w-full h-fit flex md:flex-row flex-col justify-center items-center p-2 md:p-4'>
                <div className='mt-10 md:w-3/4 w-full h-96 rounded-lg flex md:flex-row flex-col bg-[url(/hero-image.jpg)] bg-cover bg-center'>
                    ...
                    <div className='bg-white/30 md:w-1/2 w-full flex flex-col justify-center items-center md:p-5 p-2'>
                        <p className='md:text-lg text-md  text-white'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est dolores magnam ab perspiciatis quasi odit repudiandae ex cumque quidem nesciunt.</p>
            ...
            <div className='w-full pt-10 pb-10 flex justify-center'>
                <div className='md:w-3/4 w-full bg-gray-800 text-white p-6 md:p-4 rounded-xl'>
                    <h1 className='text-4xl'>How does it work?</h1>
                </div>
            </div>
            <div className='w-full flex justify-center pb-7 pt-7'>
                <div className='md:w-3/4 w-full h-fit md:gap-8 gap-4 p-2 md:p-4 flex md:flex-row flex-col md:text-lg text-md justify-center items-center bg-gray-100 rounded-xl'>
                    ...
                    <div className='md:w-1/2 w-full flex flex-col justify-center gap-4'>
                        <h2 className='md:text-2xl text-lg'><span className='font-bold'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</span> Autem, corrupti?</h2>
            ...
            <div className='w-full flex justify-center pt-7 pb-7'>
                <div className='md:w-3/4 w-full h-fit md:gap-8 gap-4 p-2 md:p-4 flex md:flex-row flex-col-reverse md:text-lg text-md 
                justify-center items-center border-2 border-gray-100 rounded-xl'>
                    <div className='md:w-1/2 w-full flex flex-col justify-center gap-4'>
                        <h2 className='md:text-2xl text-lg'><span className='font-bold'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</span> Autem, corrupti?</h2>
                        <div className='w-full md:text-lg text-md'>
